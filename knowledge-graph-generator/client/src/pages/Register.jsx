      ...
      <div className="flex-1 flex flex-col lg:flex-row relative">
        ...
        <div className="hidden lg:flex flex-col p-16 bg-slate-900/20 border-r border-slate-900/80 max-w-md w-full relative overflow-hidden shrink-0">
          ...
          <div className="flex-1 flex flex-col justify-center text-left relative z-10">
            ...
            <h2 className="text-3xl font-black tracking-tight text-gradient-primary leading-tight">
              A Complete Platform for Advanced Researchers.
            </h2>
            <p className="text-slate-400 text-xs mt-4 leading-relaxed max-w-sm">
              Build custom curricula, write notes and code within interactive terminal sandboxes, and map reference points directly from source textbooks.
            </p>

            {/* Small Metrics grid */}
            <div className="grid grid-cols-2 gap-4 mt-8 pt-8 border-t border-slate-900">
              <div>
                <span className="text-2xl font-extrabold text-emerald-400 block">450K+</span>
                <span className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Hours Saved</span>
              </div>
              <div>
                <span className="text-2xl font-extrabold text-indigo-400 block">180+</span>
                <span className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Universities</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-auto relative z-10 pt-8 border-t border-slate-900/60">
            <p className="text-xs text-slate-450 italic leading-relaxed">
              "Mapping dependencies visually makes learning high-dimensional mathematics incredibly structured and accessible."
            </p>
            <div className="flex items-center gap-2.5 mt-3">
              <div className="w-6 h-6 rounded-full bg-pink-600/20 flex items-center justify-center font-bold text-[9px] text-pink-400">
                SH
              </div>
              <span className="text-[10px] text-slate-500 font-medium">Dr. Sarah Hansen, Stanford Postdoc</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-12 relative z-10">
          <div className="w-full max-w-md glass-premium p-8 rounded-2xl">
            <h2 className="text-2xl font-bold tracking-tight text-center text-gradient-primary">Create Account</h2>
            <p className="text-xs text-slate-400 text-center mt-1">Get started mapping and exploring educational documents</p>
            ...
            <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-4">
              <div>
                <label className="block text-xs font-bold text-slate-300 uppercase tracking-wider mb-2">FullName</label>
